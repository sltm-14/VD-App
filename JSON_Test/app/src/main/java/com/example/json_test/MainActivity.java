...
public class MainActivity extends AppCompatActivity {
    ...
    public class DownloadTask extends AsyncTask<String,Void,String>{
        ...
        protected String doInBackground(String... urls) {
            ...
            /* We create our URL as a new URL from the one that we are passing to the method.
               This can fail if it's not a valid url, so it need to be surrounded by try and catch */
